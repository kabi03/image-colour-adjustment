...
void change_saturation(int wid, int heig, int chls, const double *input,double *output, double sat) {
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    ...
    if (mxIsDouble(prhs[0])){
        ...
        change_saturation(width_img, height_img, channels, img_ptr, out_ptr, sat);    
    }    
}
